...
(function () {
	...
	if ($('.crypto-currency-wrap').length) {
		...
		(function () {
			...
			s.async = true;
			var theUrl = baseUrl + 'serve/v2/coin/header?fsyms=BTC,LTC,XRP,BCH,DASH,XMR,ZEC,DOGE,ETH&tsyms=USD';
	...
	if (plugins.canvasWorld.length) {
		canvasWolrd({
			...
			colorLand: 'rgba(240,185,11,0.85)',
			colorGraticule: 'rgba(240,185,11,0.1)'
		});
	}
