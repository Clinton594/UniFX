                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row align-items-center ptb-50 res-991-ptb-20 iconalign-before-heading-row">
                            ...
                            <div class="col-md-8">
                                <p class="mb-0 ml-30 res-767-mt-20 res-767-ml-10">Professional services by consistently exceeding their expectations and bringing the highest value to each relationship. Consistently improve our deliverables organization.</p>
                            </div>
                        </div>
                        <div class="row align-items-center ptb-50 res-991-ptb-20 iconalign-before-heading-row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <p class="mb-0 ml-30 res-767-mt-20 res-767-ml-10">our work allows our clients to innovatively provide products and services to people around the world safer, faster, cleaner and more economically than ever before.</p>
                            </div>
                        </div>
                        <div class="row align-items-center ptb-50 res-991-ptb-20 iconalign-before-heading-row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <p class="mb-0 ml-30 res-767-mt-20 res-767-ml-10">A company is always looking to save money in a shrinking market, which plants should be closed, how much money it will save them, how much it will cost etc. According this we plan our strategy.</p>
                            </div>
                        </div>
                    </div>
                </div>
       ...
       <!-- team-section -->
                ...
                <div class="row">
                    <div class="wrap-team team-slide owl-carousel" data-item="3" data-nav="false" data-dots="false" data-auto="true">
                        ...
                        <div class="featured-imagebox featured-imagebox-team">
                            ...
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h5><a href="team-details.html">Michelle Harper</a></h5>
                                </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/1.jpeg" alt="image">
                                <div class="ttm-social-links-wrapper">
                                    <ul class="social-icons list-inline">
                                        <li class="social-facebook"><a class="tooltip-top" target="_blank" href="#" data-tooltip="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li class="social-twitter"><a class=" tooltip-top" target="_blank" href="#" data-tooltip="Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            ...
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h5><a href="team-details.html">Florence Charlotte</a></h5>
                                </div>
                                <p class="category">Trade Analyst</p>
                            </div>
                        </div><!-- featured-imagebox-team end-->
                         <!-- featured-imagebox-team -->
                        <div class="featured-imagebox featured-imagebox-team">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="images/2.jpeg" alt="image">
                                <div class="ttm-social-links-wrapper">
                                    <ul class="social-icons list-inline">
                                        <li class="social-facebook"><a class="tooltip-top" target="_blank" href="#" data-tooltip="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li class="social-twitter"><a class=" tooltip-top" target="_blank" href="#" data-tooltip="Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            ...
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h5><a href="team-details.html">Sophia Smith</a></h5>
                                </div>
                                <p class="category">Trade Analyst</p>
                            </div>
                        </div><!-- featured-imagebox-team end-->
        ...
        <section class="ttm-row team-work-section bg-img4 clearfix">
            <div class="container">
                ...
                <div class="separator">
                    <div class="sep-line solid mt-50 mb-25"></div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <!-- ttm-client -->
        ...
        <!-- testimonial-section -->
        <section class="ttm-row about-testimonial-section ttm-bgimage-yes map-bgimg ttm-bg ttm-bgcolor-skincolor bg-layer clearfix">
