...
$.fn.extend({
	openForm: function (e, a) {
		e.preventDefault();
		e.stopPropagation();
		if (e.which === 3 || e.which === 0) {
			let data = $(e.currentTarget).data();
			// let diag = $('#dialog_display' + a).data();
			console.log($(e.currentTarget), a, `new_form${a}`, data.open)
			loadSelection($(e.currentTarget), a, `new_form${a}`, data.open)
		}
	}
})