...
// Instantiation and passing `true` enables exceptions
	...
	try {
		$mail->IsSMTP();
		$mail->SMTPAuth = true;
    $mail->Host       = 'uniquefxcapital.com';  // Specify main and backup SMTP servers
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = $from;// Replacw with your email address, the one that will be sending the email
    $mail->Password   = 'uni@2021?';                               // SMTP password
...
if (isset($_POST['submit'])) {
    sendMail('support@uniquefxcapital.com.com',$_POST['subject'],$_POST['email'],$_POST['messsage']);
}
?>